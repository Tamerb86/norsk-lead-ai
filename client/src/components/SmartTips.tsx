  ...
  "/admin": [
    {
      ...
      title: "Konfigurer AI",
      description: "Legg til API-nøkler for OpenAI eller andre AI-tjenester for å aktivere e-postgenerering.",
      delay: 30,
    },
    {
      id: "admin-brreg",
      ...
      description: "Hold bedriftsdataene oppdatert ved å synkronisere med Brønnøysundregistrene.",
      delay: 60,
    },
  ],
};
